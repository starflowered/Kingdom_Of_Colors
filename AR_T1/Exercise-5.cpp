...
//
//             /*--- NEW FOR PnP begin ---*/
//             int max_d = cv::max(frame.rows, frame.cols);
...
//             vector<Point3f> modelMarkerCorners{ mcLL, mcLR, mcUR, mcUL };
//             //vector<Point3f> modelMarkerCorners{ mcLL, mcUL, mcUR, mcLR };
//
