...
int main()
{
    ...
    while (cap.read(frame))
    {
        ...
        for (size_t k = 0; k < contours.size(); k++)
        {
            ...
            //     0., 0., 1.);
            //
            // Mat dist_coeffs = Mat(1, 4, CV_64FC1, {0.0, 0.0, 0.0, 0.0}); // no distortions
            //
            ...
            //
            // vector<Point2f> img_marker_corners =
            //     {corners[0], corners[1], corners[2], corners[3]};
            //
            // Mat raux, taux;
            // solvePnP(model_marker_corners, img_marker_corners, k_mat, dist_coeffs, raux, taux, false);
            //
            // Mat rvec;
